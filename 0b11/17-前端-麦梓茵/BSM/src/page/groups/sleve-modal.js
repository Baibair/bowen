...
var templateAddressModal = require('./sleve-modal.string');
...
var sleveModal = {
    ...
    getProductInfo: function () {
        ...
        // }
            ...
            // if(FName == this.option.data.groupName1){
            //     selectedF = this.option.data.groupId1;
            // }
            productInfo.parentId = selectedF;
            productInfo.groupName = SName;
